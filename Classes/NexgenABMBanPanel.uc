...
function loadSearchType() {
	...
	SearchType.addItem("Search by ... IP", "2");
	SearchType.addItem("Search by ... ID", "3");
	SearchType.addItem("Search by ... HWid", "4");
	SearchType.addItem("Search by ... MACHash", "5");
	SearchType.addItem("Search by ... Hostname", "6");
...
function bool banShouldBeAdded(int index, string searchString) {
  ...
  switch(SearchType.getSelectedIndex()) {
    ...
    case 2: if(InStr(CAPS(BanData.getString("bannedIPs", index)), CAPS(SearchString)) != -1) return true; break;
    case 3: if(InStr(CAPS(BanData.getString("bannedIDs", index)), CAPS(SearchString)) != -1) return true; break;
    case 4: if(InStr(CAPS(BanData.getString("bannedHWIDs", index)), CAPS(SearchString)) != -1) return true; break;
    case 5: if(InStr(CAPS(BanData.getString("bannedMACHashes", index)), CAPS(SearchString)) != -1) return true; break;
    case 6: if(InStr(CAPS(BanData.getString("bannedHostnames", index)), CAPS(SearchString)) != -1) return true; break;
  }
